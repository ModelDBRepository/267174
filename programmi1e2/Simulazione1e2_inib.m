...
% Noise
rng(13)  % stabilisco un certo seme per ripetere le simulazioni successive
...
%% final simulation
 ...
 for prova = 1: 3
            ...
            hold on
            erroreM1hL = std( Peeg(101:300)/Max_mod1 - Pspe(101:300,ROI)/Max_spe(ROI) )
           ...
           [Peeg,f] =  pwelch(eeg(2,:),window,[],zeropadding,fs);
            ...
            hold on
            erroreM2hL = std( Peeg(101:300)/Max_mod2 - Pspe(101:300,ROI+1)/Max_spe(ROI+1) )
        ...
        figure(4)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h L - M1h R','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hL_M1hR = std( Cxy(101:301) - C_baseline_media{1,2}(101:301) )
                case 2
                    plot(f(100:end),Cxy(100:end),'color',0.5*colore+0.3,'linewidth',2)
                    hold on 
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hL_M1hR = std( Cxy(101:301) - C_affected_media{1,2}(101:301) )
                case 3
                    plot(f(100:end),Cxy(100:end),'color',0.5*colore+0.3,'linewidth',2)
                    hold on 
                    plot(f(100:end),C_unaffected_media{1,2}(100:end),'--','color',0.5*colore+0.3,'linewidth',2)
                    title('unaffected','fontsize',font)
                    error_CM1hL_M1hR = std( Cxy(101:301) - C_unaffected_media{1,2}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h L - SMAp L','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hL_SMApL = std( Cxy(101:301) - C_baseline_media{1,3}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hL_SMApL = std( Cxy(101:301) - C_affected_media{1,3}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hL_SMApL = std( Cxy(101:301) - C_unaffected_media{1,3}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h L - SMAp R','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hL_SMApR = std( Cxy(101:301) - C_baseline_media{1,4}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hL_SMApR = std( Cxy(101:301) - C_affected_media{1,4}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hL_SMApR = std( Cxy(101:301) - C_unaffected_media{1,4}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h L - PMD L','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hL_PMDL = std( Cxy(101:301) - C_baseline_media{1,5}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hL_PMDL = std( Cxy(101:301) - C_affected_media{1,5}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hL_PMDL = std( Cxy(101:301) - C_unaffected_media{1,5}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h L - PMD R','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hL_PMDR = std( Cxy(101:301) - C_baseline_media{1,6}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hL_PMDR = std( Cxy(101:301) - C_affected_media{1,6}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hL_PMDR = std( Cxy(101:301) - C_unaffected_media{1,6}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h R - SMAp L','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hR_SMApL = std( Cxy(101:301) - C_baseline_media{2,3}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hR_SMApL = std( Cxy(101:301) - C_affected_media{2,3}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hR_SMApL = std( Cxy(101:301) - C_unaffected_media{2,3}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h R - SMAp R','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hR_SMApR = std( Cxy(101:301) - C_baseline_media{2,4}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hR_SMApR = std( Cxy(101:301) - C_affected_media{2,4}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hR_SMApR = std( Cxy(101:301) - C_unaffected_media{2,4}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h R - PMD L','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hR_PMDL = std( Cxy(101:301) - C_baseline_media{2,5}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hR_PMDL = std( Cxy(101:301) - C_affected_media{2,5}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hR_PMDL = std( Cxy(101:301) - C_unaffected_media{2,5}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
            ...
            switch prova
                case 1
                    ...
                    ylabel('Coeher. M1h R - PMD R','fontsize',font)
                    title('basal','fontsize',font)
                    error_CM1hR_PMDR = std( Cxy(101:301) - C_baseline_media{2,6}(101:301) )
                case 2
                    ...
                    title('affected','fontsize',font)
                    xlabel('Frequency (Hz)','fontsize',font)
                    error_CM1hR_PMDR = std( Cxy(101:301) - C_affected_media{2,6}(101:301) )
                case 3
                    ...
                    title('unaffected','fontsize',font)
                    error_CM1hR_PMDR = std( Cxy(101:301) - C_unaffected_media{2,6}(101:301) )
            end
            axis([0 50 0 1])
            set(gca,'fontsize',font)
        ...
        mean(zp1_prova2,2)
        mean(zp1_prova3,2)
% save uscite_12_inib zp1_prova1 zp1_prova2 zp1_prova3
% save eeg_12_inib eeg1_prova1 eeg1_prova2 eeg1_prova3